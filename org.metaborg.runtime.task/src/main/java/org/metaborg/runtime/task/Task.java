...
public class Task implements ITask {
    ...
    @Override public IStrategoAppl instruction() {
        if(instructionOverride == null)
            return instruction;
        return instructionOverride;
    }

    @Override public void overrideInstruction(IStrategoAppl newInstruction) {
        instructionOverride = newInstruction;
    }

    @Override public IStrategoAppl instructionOverride() {
        return instructionOverride;
    }

    @Override public IStrategoAppl initialInstruction() {
        return instruction;
    }

    @Override public void clearInstructionOverride() {
        instructionOverride = null;
    }


    @Override public IStrategoList initialDependencies() {
    ...
    @Override public TaskStorageType storageType() {
        return storageType;
    }

    @Override public TaskStorageType actualStorageType() {
        return results.type();
    }
    ...
    @Override public ITaskResults results() {
        return results;
    }
    ...
    @Override public void setStatus(TaskStatus status) {
        this.status = status;
    }
    ...
    @Override public boolean dependencyFailed() {
        return status == TaskStatus.DependencyFail;
    }

    @Override public void setDependencyFailed() {
    ...
    @Override public IStrategoTerm message() {
        return message;
    }

    @Override public void setMessage(IStrategoTerm message) {
    ...
    @Override public void clearTime() {
        time = -1;
    }


    @Override public short evaluations() {
        return evaluations;
    }

    @Override public void setEvaluations(short evaluations) {
        this.evaluations = evaluations;
    }

    @Override public void addEvaluation() {
        ++evaluations;
    }
