...
public class SequenceTask implements ITaskFactory, ITaskQueuer, ITaskEvaluator {
    ...
    @Override public IStrategoList adjustDependencies(IStrategoList dependencies) {
        return factory.makeList();
    }

    @Override public ITask create(IStrategoAppl instruction, IStrategoList dependencies, TaskType type,
    ...
    @Override public ITask clone(ITask task) {
        return new Task((Task) task); // TODO: get rid of cast or ITask interface.
    }


    @Override public void queue(ITaskEngine taskEngine, ITaskEvaluationQueue evaluationQueue,
    ...
    @Override public void evaluate(IStrategoTerm taskID, ITask task, ITaskEngine taskEngine,
