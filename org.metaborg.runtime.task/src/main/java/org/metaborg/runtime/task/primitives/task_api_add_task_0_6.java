...
public class task_api_add_task_0_6 extends TaskEnginePrimitive {
    ...
    @Override public boolean call(ITaskEngine taskEngine, IContext env, Strategy[] svars, IStrategoTerm[] tvars)
        ...
        env.setCurrent(taskEngine.addTask(source, dependencies, instruction, TaskType.get(taskType.intValue()),
