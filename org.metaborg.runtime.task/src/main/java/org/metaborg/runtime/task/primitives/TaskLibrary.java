...
import org.metaborg.runtime.task.primitives.legacy.RemovedAbstractPrimitive;
...
public class TaskLibrary extends AbstractStrategoOperatorRegistry {
    ...
    public TaskLibrary() {
        ...
        add(new RemovedAbstractPrimitive("task_api_merge", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_persist", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_pop", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_push", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_recover", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_reset", 0, 0));
        add(new RemovedAbstractPrimitive("task_api_setup", 0, 1));
        add(new RemovedAbstractPrimitive("task_api_unload", 0, 1));
    }
